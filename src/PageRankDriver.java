...
public class PageRankDriver extends Configured implements Tool {
  ...
  /**
   * Configure the 1st job Parse the XML to Page with Default ranks 1.0 and outLinks
   * 
   * @param inputPath
   * @param outputPath
   * @return Boolean
  ...
  /**
   * Configure the 2nd job Calculate new Page Rank
   * 
   * @param inputPath
   * @param outputPath
   * @return Boolean
  ...
  /**
   * Configure the 3rd job Order last run on PageRank (Descending)
   * 
   * @param inputPath
   * @param outputPath
   * @return Boolean
